...
/*************************自定义宏**********************************/
// spi_port
#define  NRF24L01_SPIx                SPI3                  // SPI 端口   

// 第3脚:CE
#define  NRF24L01_CE_GPIO             GPIOD                 // CE 工作模式开启， 高电平有效，发射/接收模式控制
...
#define  NRF24L01_IQR_PIN            GPIO_Pin_4
#define  NRF24L01_IQR_Channel        EXTI4_IRQn
#define  NRF24L01_IQR_SourceGPIO    GPIO_PortSourceGPIOD
#define  NRF24L01_IQR_PinSource     GPIO_PinSource4
#define  NRF24L01_IQR_Line          EXTI_Line4
